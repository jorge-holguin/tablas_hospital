...
export default function ListadoProformasPage() {
  ...
  const handleImprimir = () => {
    alert("Generando listado de proformas entre fechas...")
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Listado de Proformas entre Fechas</h1>
          <p className="text-muted-foreground text-sm">Reporte de proformas en un rango de fechas</p>
        </div>
