...
export default function RecetasDepartamentoPage() {
  ...
  const handleImprimir = () => {
    alert("Generando reporte de recetas por departamento...")
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Recetas por Departamento</h1>
          <p className="text-muted-foreground text-sm">Análisis de recetas por departamento</p>
        </div>
      ...
      <Card className="max-w-xl mx-auto">
        <CardHeader>
          <CardTitle className="text-xl">Recetas Atendidas por Departamento</CardTitle>
        </CardHeader>
