...
export default function CurvaABCDemandaPage() {
  ...
  const handleImprimir = () => {
    alert("Generando reporte de Curva ABC Demanda Insatisfecha...")
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Curva ABC Demanda Insatisfecha</h1>
          <p className="text-muted-foreground text-sm">Análisis ABC de demanda insatisfecha</p>
        </div>
      ...
      <Card className="max-w-xl mx-auto">
        <CardHeader>
          <CardTitle className="text-xl">Curva ABC Demanda Insatisfecha</CardTitle>
        </CardHeader>
