...
export default function DevolucionesMedicamentosPage() {
  ...
  const handleImprimir = () => {
    alert("Generando reporte de Devolución de Medicamentos...")
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Devolución de Medicamentos</h1>
          <p className="text-muted-foreground text-sm">Análisis de devoluciones</p>
        </div>
      ...
      <Card className="max-w-xl mx-auto">
        <CardHeader>
          <CardTitle className="text-xl">Devolución de Medicamentos</CardTitle>
        </CardHeader>
